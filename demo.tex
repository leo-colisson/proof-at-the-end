...
% Last loaded package (except cleveref that must be loaded even later)
\usepackage{hyperref}

%% Define your theorem/lemma/... environments the way you want (must be called after hyperref https://tex.stackexchange.com/q/757925/116348):
% Theorems
\newtheorem{thm}{Theorem}[section]
\newtheorem*{thm*}{Theorem}
\providecommand*\thmautorefname{Theorem}
\renewcommand\theHthm{\thesection .\arabic {thm}} % Needed until https://github.com/muzimuzhi/thmtools/issues/70 is fixed or use \hypersetup{hypertexnames=false}
% Lemmata
\newtheorem{lemma}[thm]{Lemma}
\newtheorem*{lemma*}{Lemma}
\providecommand*\lemmaautorefname{Lemma}
\renewcommand\theHlemma{\thesection .\arabic {lemma}} % Needed until https://github.com/muzimuzhi/thmtools/issues/70 is fixed or use \hypersetup{hypertexnames=false}
\begin{document}
...
\begin{proofED}
  ...
  with synctex now. And solves \href{https://github.com/leo-colisson/proof-at-the-end/issues/10}{Issue 10}.
\end{proofED}
