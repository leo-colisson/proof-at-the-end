...
% WARNING: load this AFTER \newtheorem due to a bug in thmtools
% https://github.com/muzimuzhi/thmtools/issues/70
% or call \hypersetup{hypertexnames=false} (but does not work if you use index)
