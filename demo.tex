...
\usepackage{hyperref}
% Load the package (put the proofAtTheEnd.sty file in the working directory)
\usepackage{proofAtTheEnd} % with default options...
% Or by putting in the 'conf' option the default configuration you want:
%\usepackage[conf={normal, one big link}]{proofAtTheEnd}
%\usepackage[conf={normal, one big link=Goto proof}]{proofAtTheEnd}
%\usepackage[conf={one big link translated=Aller à la preuve page}]{proofAtTheEnd}
